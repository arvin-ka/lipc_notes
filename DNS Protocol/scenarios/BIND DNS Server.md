...
* **میزبان‌های موجود در شبکه (Hosts):**
  * `ns1.lab.local` ➔ `192.168.10.10` (خود سرور DNS)
  * `web.lab.local` ➔ `192.168.10.50` (سرور وب)
  * `mail.lab.local` ➔ `192.168.10.60` (سرور ایمیل)
  * `app.lab.local` ➔ `192.168.10.70` (سرور برنامه)
